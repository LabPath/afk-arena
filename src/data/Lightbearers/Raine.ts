...
export const Raine: Hero = {
    ...
    armor: 'Leather',
    signature: {
        name: 'Dueling Blasters',
        description: 'A pair of reliable old blasters. Good for gettings into and out of sticky situations',
        skill: 'Helping Hand',
        unlock: 'Raine locks onto the ally with the highest ATK points, allowing them to recover health and energy every 2 seconds. The amount of health and energy recovered every 2 seconds is equal to 30% of Raine\'s own recovery rate',
