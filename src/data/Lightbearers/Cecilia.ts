...
export const Cecilia: Hero = {
    ...
    armor: 'Leather',
    signature: {
        name: 'Book of Cleansing',
        description: 'A divine book that contains prayers used to exorcise demonic spirits and drive away evil',
        skill: 'Repentance',
        unlock: 'All allied heroes including Cecilia recover 200 energy points and a total equivalent of 150% worth of Cecilia\'s attack rating as health over 5 seconds whenever the ability \'Judgement Day\' kills an enemy in less than 5 seconds',
