...
export const Rowan: Hero = {
    ...
    signature: {
        ...
        skill: 'Thirsty Work',
        default: 'After entering the battle Rowan will set up a stall that now includes an energy potion. When an ally’s energy is above 600 points they will drink a potion, replenishing 60 energy points. The energy potion will be replenished each time the stall is set up',
