...
export const Belinda: Hero = {
    ...
    signature: {
        ...
        default: 'All allies that are receiving the effects of the ability \'Blessing\' will have a 40% chance to activate the \'Divine Retribution\' ability. This ability can be activated up to 3 times every 5 seconds. Damage dealt by this ability is equal to 40% of the ability’s original damage when used by allies',
