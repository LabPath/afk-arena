...
export const ElijahAndLailah: Hero = {
    ...
    armor: 'Padded',
    signature: {
        item: 'Bonding Feathers',
        description: 'A pair of headdresses that allow an uncanny connection between the wearers',
        skill: 'Blessed Binding',
        default: 'When Lailah and Elijah are in close proximity to one another, their attack rating will be increased by 5%. When they are far apart from one another, their defense rating will be increased by 15%',
