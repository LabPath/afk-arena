...
export const WuKong: Hero = {
    ...
    signature: {
        ...
        unlock: 'Wu Kong gains a 2-layer protective barrier at the start of battles. If Wu Kong is dealt damage that exceeds 10% of his max health he will lose 1 layer and mitigate the damage received',
