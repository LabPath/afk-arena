...
export const Ukyo: Hero = {
    ...
    signature: {
        ...
        skill: 'Rage Eruption',
        default: 'This ability can be used once per battle. After using his ultimate ability, Ukyo will be immune to all control abilites for 8 seconds, his Attack Rating will be increased by 20% and his Life Leech attribute will be increased by 10 points',
