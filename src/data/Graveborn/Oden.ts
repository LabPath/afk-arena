...
export const Oden: Hero = {
    ...
    signature: {
        ...
        skill: 'Vengeful Fury',
        default: 'Each time an enemy uses their ultimate ability against Oden, Oden will retaliate against them with his \'Void Lightning\' ability. Damage dealt is equal to 60% of the original \'Void Lightning\' ability\'s damage output',
