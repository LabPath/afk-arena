...
export const Nara: Hero = {
    ...
    signature: {
        ...
        skill: 'Looming Death',
        unlock: 'When Nara discovers an enemy injured enough to be slain by her ultimate ability, she will attempt to use \'Impale\' to bring them closer to her before using her ultimate ability to finish them off',
