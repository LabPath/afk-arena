...
export const Daimon: Hero = {
    ...
    signature: {
        ...
        skill: 'Soul Sunder',
        default: 'After using the ability \'Blood Shield\', while the shield is still in use, Daimon temporarily gains 20% of the enemy target\'s Attack Rating and 30% of their Defense Rating. This ability cannot be stacked',
