...
export const Torne: Hero = {
    ...
    signature: {
        ...
        skill: 'Baneful Focus',
        default: 'Every time Torne forms a bone whip, his Attack Rating is increased by 10% and his Defense Rating is increased by 20% up until the battle ends. This ability can be stacked 6 times',
