...
export const Theowyn: Hero = {
    ...
    signature: {
        ...
        default: 'This ability is activated every 15 seconds of battle. The 1 enemies which have dealt the highest amount of damage to Theowyn within the last 15 seconds shall be afflicted by the effects of Theowyn’s \'Spectral Curse\' ability',
