...
export const Safiya: Hero = {
    ...
    signature: {
        ...
        skill: 'Arcane Power',
        unlock: '1% of Safiya\'s total damage output is converted into her attack rating. The attack rating can be increased up to a total of 140%',
