...
export const Drez: Hero = {
    ...
    signature: {
        ...
        unlock: 'After using his Ultimate ability, Drez receives a shield which is able to mitigate damage worth 400% of his Attack Rating value for a duration of 5 seconds. This ability can be activated 2 times per battle',
