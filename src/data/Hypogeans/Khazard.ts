...
export const Khazard: Hero = {
    ...
    armor: 'Padded',
    signature: {
        name: 'The Frigid Aura',
        description: 'Frozen in perpetuity, this object emanates a coldness that is able to cut through bone and steel',
        skill: 'Frozen Curse',
        unlock: 'Increases the duration of most negative debuff effects which are currently affecting all enemies on the battlefield by 30% seconds',
