...
export const Mortas: Hero = {
    ...
    signature: {
        ...
        skill: 'Trickery',
        unlock: 'When a Normal Attack deals a Critical Strike, another enemy is additionally struck, however, the damage dealt is reduced 70% and the additional attack does not trigger any effects',
